...
func (f fakeRemoteResolver) ImageDigest(ctx context.Context, imageRef string) (string, error) {
	if ctx != nil {
...
func newDockerClientForImageInspect(t *testing.T, imageRef string, repoDigests []string, imageID string) *client.Client {
	t.Helper()
...
func TestCheckerCheckImageNeedsUpdateSkipsDigestPinnedReference(t *testing.T) {
...
func TestCheckerCheckImageNeedsUpdateMatchesManifestListRepoDigest(t *testing.T) {
...
func TestCheckerCheckImageNeedsUpdateTreatsPlatformDigestMismatchAsUpdate(t *testing.T) {
	listDigest := ocidigest.FromString("manifest-list").String()
